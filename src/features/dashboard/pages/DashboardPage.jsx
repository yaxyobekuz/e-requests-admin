    ...
    <div className="p-6 max-w-screen-xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-2">
          {isOwner
            ? "Tizim boshqaruvi paneli"
            : "Tayinlangan hudud boshqaruvi"}
        </p>
      </div>
        ...
        {isOwner && (
          <>
            <QuickLinkCard
              to="/admin-roles"
              title="Lavozimlar"
              description="Admin lavozimlarini boshqarish"
            ...
            <QuickLinkCard
              to="/services"
              title="Servislar"
              description="Xizmat turlarini sozlash"
            ...
            <QuickLinkCard
              to="/msk/categories"
              title="MSK kategoriyalar"
              description="MSK mahsulot kategoriyalarini sozlash"
            ...
            <QuickLinkCard
              to="/regions"
              title="Hududlar"
              description="Viloyat, tuman va mahallalarni boshqarish"
