 ...
 * 3-ustunli grid (lg: 6-ustun) — DEMOGRAPHICS_KPI_CONFIG bo'yicha.
 *
    ...
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
      {DEMOGRAPHICS_KPI_CONFIG.map((cfg) => {
        ...
        return (
          <Card key={cfg.key} className="flex items-center gap-3">
            <div
              className={`size-10 rounded-lg flex items-center justify-center flex-shrink-0 ${colors.bg} ${colors.text}`}
            >
              {ICONS[cfg.icon]}
            </div>
